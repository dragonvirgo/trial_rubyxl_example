...
def get_sheets_data_example(workbook)
...
get_sheets_data_example(workbook)


p "-- xls へ保存してxlsxへ変換したExcel --"

workbook = RubyXL::Parser.parse("../data/これはテスト＿20140417_from_xls.xlsx")
